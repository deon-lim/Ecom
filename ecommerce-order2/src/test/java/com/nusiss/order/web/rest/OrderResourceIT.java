...
import static com.nusiss.order.domain.OrderAsserts.*;
import static com.nusiss.order.web.rest.TestUtil.createUpdateProxyForBean;
import static com.nusiss.order.web.rest.TestUtil.sameNumber;
...
class OrderResourceIT {
    ...
    public static Order createEntity() {
        return new Order().customerId(DEFAULT_CUSTOMER_ID).totalAmount(DEFAULT_TOTAL_AMOUNT).createdOn(DEFAULT_CREATED_ON);
    }
    ...
    public static Order createUpdatedEntity() {
        return new Order().customerId(UPDATED_CUSTOMER_ID).totalAmount(UPDATED_TOTAL_AMOUNT).createdOn(UPDATED_CREATED_ON);
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.customerId(UPDATED_CUSTOMER_ID).totalAmount(UPDATED_TOTAL_AMOUNT).createdOn(UPDATED_CREATED_ON);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.customerId(UPDATED_CUSTOMER_ID);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.customerId(UPDATED_CUSTOMER_ID).totalAmount(UPDATED_TOTAL_AMOUNT).createdOn(UPDATED_CREATED_ON);
